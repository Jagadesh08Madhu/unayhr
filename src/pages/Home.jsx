  ...
  return (
    <div>
      <section className="font-lora py-20 bg-[#101941] text-white">
        <div className="flex flex-col gap-8 h-[60vh] justify-center mx-5 lg:mx-0 text-center md:text-left items-center">
          <h1
            style={{ letterSpacing: "5px" }}
            className="text-4xl font-semibold"
          >
            Payroll simplified, efficient, and compliant
          </h1>
          <p className="text-lg leading-loose">
            Streamline your payroll operations and empower your workforce with
            UnayHR's modern payroll solutions—designed for growing businesses.
          </p>
          <div className="flex flex-col gap-5 w-full md:flex-row md:w-fit lg:gap-10">
            <button
              onClick={() => navigate("/pricing")}
              style={{ letterSpacing: "5px" }}
              className="bg-white rounded-md text-[#101941] px-6 py-3 text-sm lg:text-lg"
            >
              Our Pricing
            </button>
            <button
              ...
              style={{ letterSpacing: "5px" }}
              className="bg-transparent rounded-md border px-6 py-3 text-sm lg:text-lg"
            >
              Contact us
            </button>
          </div>
        ...
        {/* Image section */}
        <div className="flex justify-center gap-10 lg:mx-20 mx-3 py-10">
          {/* Left Side */}
          {/* <motion.div
          ...
          >
            <img
              className="rounded-2xl border-white/30 border"
              src={right}
              alt=""
            />
